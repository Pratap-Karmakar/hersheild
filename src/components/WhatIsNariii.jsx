    ...
    <section className="py-24 bg-gradient-to-br from-purple-500 to-purple-700 relative overflow-hidden">
      ...
      >
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            What is <span className="text-yellow-300">HerShield</span>?
          </motion.h2>
          <motion.p 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            HerShield is a pioneering social impact module dedicated to creating responsive, inclusive, safe, and equitable urban systems. We collaborate with government and non-government stakeholders, harnessing the power of big data to revolutionize city infrastructure and services.
          </motion.p>
          <Link href="/whatIshershield"> {/* Wrap the button with Link */}
            <motion.button 
...
export default WhatIsHerShield;
